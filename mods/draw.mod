...
drawmap["fail"]=nil
drawmap["pathindex"]=0
drawmap["pathlist"]={citypath["yz"],citypath["xi"],citypath["ca"],citypath["cd"],citypath["dl"],citypath["fz"],citypath["fs"],citypath["gw"],citypath["hs"],citypath["hz"],citypath["lz"],citypath["rz"],citypath["sz"],citypath["xx"],citypath["wg"],citypath["zn"]}
