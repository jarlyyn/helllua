...
updateversion=function()
	...
	addtri("walk_boatout","^(> )*少女说: “到啦，上岸吧。”，随即一点竹篙，把舟泊好。","system","on_boatout")
	...
	addtri("walk_busy","^(> )*(你的动作还没有完成，不能移动|你逃跑失败|你被拦住了去路|你突然发现眼前的景象有些迷乱|你太累了，还是休息一会儿吧|你的内力不够，还是休息一下再说吧|这里没有这样东西可骑|现在白雕正忙着|只听得湖面上隐隐传来：“就来了啦……”)","system","walk_on_busy")
